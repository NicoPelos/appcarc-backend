...
const ROLES_SEED = [
  ...
  },
  {
    ...
    permisos: [
      ...
      P.EVENTOS_READ, P.EVENTOS_WRITE, P.EVENTOS_DELETE,
      ...
      P.USUARIOS_WRITE,
      P.ROLES_READ,
      P.RECURSOS_READ, P.RECURSOS_WRITE, P.RECURSOS_DELETE,
    ],
  },
  {
    nombre: 'profesor',
  ...
  },
  {
    nombre: 'socio',
    permisos: [
      P.MURO_LIBRE_READ, P.MURO_LIBRE_CHECKIN_PROPIO,
      P.ESCUELITA_CHECKIN_PROPIO,
      P.ASISTENCIAS_READ,
    ],
  },
];
